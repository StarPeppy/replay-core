...
public class RTPHere implements CommandExecutor {
	private StarPep plugin;
	public RTPHere(StarPep pl){
		plugin = pl;
	}
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(args.length != 1){
			player.sendMessage(ChatColor.DARK_AQUA + "/rtphere <player>");
			return false;
		}
		Player target = null;
		...
		player.sendMessage(ChatColor.BLUE + "Teleported " + ChatColor.AQUA + target.getName() + ChatColor.BLUE + " to you.");
		return true;
	}
